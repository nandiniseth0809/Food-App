...
st.write(
    "To know more about this app, visit [**GitHub**]()")
...
try:
    ...
    st.warning(
        "Please create a **Issue** on [Github](https://github.com/nandiniseth0809)")


st.markdown("Created by **Nandini Seth**")
st.markdown(body="""

<th style="border:None"><a href="https://www.linkedin.com/in/nandiniseth/" target="blank"><img align="center" src="https://bit.ly/3wCl82U" alt="Linkedin" height="40" width="40" /></a></th>
<th style="border:None"><a href="https://github.com/nandiniseth0809" target="blank"><img alignhttps://github.com/nandiniseth0809="center" src="https://bit.ly/3c2onZS" alt="Git" height="40" width="40" /></a></th>
